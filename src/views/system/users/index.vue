...
<!--    <Tree ref="tree" class="list-tree" />-->
    <div class="list-containerOther">
      <div>
        <tabs-bar ref="tabs" @showDialog="handlerDialog" @delList="delList" @delGroup="delGroup" @uploadList="upload" @uploadAll="uploadAll" @queryBtn="query" @showGroupDialog="groupDialog"  />
      </div>
